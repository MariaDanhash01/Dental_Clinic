                                          ...
                                          <td>
                                              <div class="dropdown">
                                                  ...
                                                  <div class="dropdown-menu">
                                                      <form method="post" action="{{route('admin.department.delete' ,$department->id)}}">
                                                          @csrf
                                                          @method('delete')
                                                        ...
                                                        <a href="{{route('admin.department.edit',$department->id)}}" class="dropdown-item btn" type="submit">
