                                          ...
                                          <td>
                                              <div class="dropdown">
                                                  ...
                                                  <div class="dropdown-menu">
                                                      <form method="post" action="{{route('admin.receptionist.delete' ,$receptionist->id)}}">
                                                          @csrf
                                                          @method('delete')
                                                        ...
                                                        <a href="{{route('admin.receptionist.edit',$receptionist->id)}}" class="dropdown-item btn" type="submit">
